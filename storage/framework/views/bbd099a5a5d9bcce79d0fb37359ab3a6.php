...
<div class="pr-cat-card h-100" data-testid="card-animal-<?php echo e($animal->id); ?>">
    ...
    <div class="pr-cat-card-img">
        <img src="<?php echo e($animal->mainPhotoUrl()); ?>" alt="<?php echo e($animal->name); ?>" loading="lazy">
        ...
        <?php if(auth()->guard()->check()): ?>
            <form method="POST" action="<?php echo e(route('favorites.toggle', $animal)); ?>" class="m-0 p-0">
                ...
                <button type="submit"
                    ...
                    <i class="bi <?php echo e($isFav ? 'bi-heart-fill text-danger' : 'bi-heart'); ?>"></i>
                </button>
            </form>
        <?php else: ?>
    ...
    <div class="pr-cat-card-body">
        <div class="d-flex justify-content-between align-items-start mb-1">
            <h6 class="pr-cat-card-name m-0" data-testid="text-animal-name-<?php echo e($animal->id); ?>">
                <?php echo e($animal->name); ?>

            </h6>
            <small class="pr-muted flex-shrink-0 ms-2" data-testid="text-animal-age-<?php echo e($animal->id); ?>">
                <?php echo e($animal->ageLabel()); ?>

            </small>
        </div>

        <div class="pr-muted small mb-2" data-testid="text-animal-breed-<?php echo e($animal->id); ?>">
            <?php echo e($animal->breed); ?>

        </div>

        <div class="pr-muted small mb-3" data-testid="text-animal-location-<?php echo e($animal->id); ?>">
        ...
        <a href="<?php echo e(route('animals.show', $animal)); ?>"
           ...
           data-testid="link-detail-<?php echo e($animal->id); ?>">
            Lihat Detail
        </a>
    </div>
</div><?php /**PATH C:\Users\LENOVO\Pawrise\resources\views/partials/animal-card.blade.php ENDPATH**/ ?>