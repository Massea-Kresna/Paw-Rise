                ...
                <div class="pr-filter-card">
                    <form method="GET" action="<?php echo e(route('catalog.index')); ?>" id="filterForm">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <a href="<?php echo e(route('catalog.index')); ?>" class="pr-filter-reset" data-testid="link-reset-filter">Reset</a>
                        </div>
                        ...
                        <div class="pr-filter-group">
                            ...
                            <div class="pr-pill-group">
                                <?php $__currentLoopData = ['jantan'=>'Jantan','betina'=>'Betina']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <label class="pr-pill <?php echo e($active ? 'active' : ''); ?>" data-testid="pill-gender-<?php echo e($val); ?>">
                                        <input type="radio" name="gender" value="<?php echo e($val); ?>" <?php echo e($active ? 'checked' : ''); ?> hidden>
                                        <?php echo e($label); ?>
            ...
            <div class="col-lg-9">
                <div class="d-flex flex-wrap justify-content-between align-items-start mb-4 gap-3">
                    <div>
                        ...
                        <p class="pr-muted mb-0" data-testid="text-total-count"><?php echo e($animals->total()); ?> hewan sedang mencari rumah.</p>
                    </div>
                    ...
                    <form method="GET" class="pr-sort-chip">
                        <?php $__currentLoopData = request()->except('sort','page'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(is_array($v)): ?>
                                <?php $__currentLoopData = $v; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><input type="hidden" name="<?php echo e($k); ?>[]" value="<?php echo e($vv); ?>"><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                ...
                <?php if($animals->count()): ?>
                    <div class="row g-4">
                        <?php $__currentLoopData = $animals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $animal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-sm-6 col-xl-4"><?php echo $__env->make('partials.animal-card', ['animal' => $animal], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                        ...
                        <nav class="pr-pagination mt-5" aria-label="Pagination">
                            <ul>
                                <li class="<?php echo e($animals->onFirstPage() ? 'disabled' : ''); ?>">
                                    <a href="<?php echo e($animals->previousPageUrl() ?? '#'); ?>" data-testid="link-prev-page"><i class="bi bi-chevron-left"></i></a>
                                </li>
                                <?php for($i = 1; $i <= $animals->lastPage(); $i++): ?>
                                    <li class="<?php echo e($animals->currentPage() === $i ? 'active' : ''); ?>">
                                        <a href="<?php echo e($animals->url($i)); ?>" data-testid="link-page-<?php echo e($i); ?>"><?php echo e($i); ?></a>
                                    </li>
                                <?php endfor; ?>
                                <li class="<?php echo e(! $animals->hasMorePages() ? 'disabled' : ''); ?>">
                                    <a href="<?php echo e($animals->nextPageUrl() ?? '#'); ?>" data-testid="link-next-page"><i class="bi bi-chevron-right"></i></a>
                                </li>
                            </ul>
                        </nav>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Pawrise\resources\views/catalog/index.blade.php ENDPATH**/ ?>