...
<section class="pr-section" style="background:#F4F5F9;">
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-2">
            ...
            <a href="<?php echo e(route('education')); ?>" class="d-inline-flex align-items-center gap-2 fw-bold text-decoration-none mt-2" style="color:var(--pr-orange); white-space:nowrap;">
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <a href="<?php echo e(route('education')); ?>" class="text-decoration-none d-block h-100">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Pawrise\resources\views/home/landing.blade.php ENDPATH**/ ?>