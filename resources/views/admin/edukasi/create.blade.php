...
@section('title', 'Tambah Konten Edukasi - PawRise Admin')
@section('content')
...
<h3 class="fw-bold mt-3 mb-4">Tambah Konten Edukasi</h3>
    ...
    <div class="form-card">
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <textarea name="ringkasan" class="form-control" rows="3" placeholder="Ringkasan singkat artikel..." required style="min-height: 80px;">{{ old('ringkasan') }}</textarea>
            </div>

            {{-- Konten --}}
            <div class="col-12">
                <label class="form-label">Konten <span class="text-danger">*</span></label>
                <textarea name="konten" class="form-control" placeholder="Tulis konten artikel lengkap..." required>{{ old('konten') }}</textarea>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="estimasi_baca" class="form-control" value="{{ old('estimasi_baca') }}" placeholder="5" min="1">
            </div>
            ...
            <div class="col-12">
                ...
                <img id="gambarPreview" class="img-preview" alt="Preview">
            </div>

            {{-- Publish --}}
            <div class="col-12">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="is_published" value="1" id="publishCheck" {{ old('is_published') ? 'checked' : '' }}
